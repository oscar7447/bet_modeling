...
if __name__=='__main__':
    ...
    season_df = matchhistorical[matchhistorical['season']==season]
    ...
    if current_matchweek==1:
        ...
        table = table_simulation(matchhistorical, competition, season, current_matchweek)
        season_points = np.random.choice(points_vector, remaining_matches)
    sims = 5000
    tmp_table = table[['team_name']].copy()
    for j in range(sims):
